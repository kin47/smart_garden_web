...
class _AuthService implements AuthService {
  ...
  @override
  Future<BaseData<UserModel>> getUserInfo() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BaseData<UserModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = BaseData<UserModel>.fromJson(
      _result.data!,
  ...
  @override
  Future<BaseData<dynamic>> resendEmailVerification(
      {required ResendEmailRequest request}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
