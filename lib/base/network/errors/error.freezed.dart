...
class __$$DataErrorImplCopyWithImpl<$Res>
    extends _$BaseErrorCopyWithImpl<$Res, _$DataErrorImpl>
...
class _$DataErrorImpl implements DataError {
  ...
  @override
  String toString() {
    return 'BaseError.dataError(message: $message)';
  }
...
abstract class DataError implements BaseError {
  const factory DataError(final String message) = _$DataErrorImpl;
